...
const mockPostData = {
  ...
  gender: "all",
  cost: "15000",
  description: "안녕하세요! 매주 토요일마다 축구하는 모임입니다. 초보자도 환영하며, 재미있게 운동하실 분들 모집합니다.",
}
...
예) 초보자 환영, 준비물, 운동 후 식사 계획 등`}
            ...
            maxLength={300}
          />
          <div className="text-right text-sm text-gray-500 mt-1">{formData.description.length}/300자</div>
        </div>
